        ...
        <div class="page-content-wrapper">
            <div class="page-content is-relative">
                ...
                <div class="datatable-toolbar">
                    ...
                    <div class="buttons">
                        <a href="{{ route('textile.add') }}" class="button h-button is-primary is-elevated">
                                <span class="icon">
                                  <i aria-hidden="true" class="fas fa-plus"></i>
                              </span>
                            <span>Добавить ткань</span>
                        </a>
                    </div>
                </div>
                            ...
                            @foreach($textile as $item)
                                <tr data-id="0">
                                    ...
                                    <td class="has-text-right">
                                        <a href="{{ route('textile.edit', $item->id) }}" class="button h-button">
                                        <span class="icon">
