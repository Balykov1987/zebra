            ...
            <div class="page-content is-relative">
                ...
                <div class="page-title has-text-centered">
                    ...
                    <div class="title-wrap">
                        <h1 class="title is-4">Комплектующие</h1>
                    </div>
                ...
                <div class="datatable-toolbar">
                    ...
                    <div class="buttons">
                        <a href="{{ route('product.add') }}" class="button h-button is-primary is-elevated">
                                <span class="icon">
                            ...
                            @foreach($products as $product)
                                <tr data-id="0">
                                    ...
                                    <td class="has-text-right">
                                        <a href="{{ route('product.edit', $product->id) }}" class="button h-button">
                                        <span class="icon">
