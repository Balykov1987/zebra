                    ...
                    <div class="demo-card">
                        <form method="post" action="{{ route('product.update', $product->id ) }}" role="form"
                            ...
                            <div class="demo-title">
                                ...
                                <div class="field">
                                    <div class="control">
                                        <input name="title" type="text" class="input" placeholder="Название" value="{{$product->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <div class="control">
                                        <input name="article" type="text" class="input" placeholder="Артикул" value="{{$product->article}}">
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <div class="control">
                                        <input name="price" type="text" class="input" placeholder="Цена" value="{{$product->price}}">
                                    </div>
                                </div>
